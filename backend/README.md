...
## Project Structure
    ...
    ├── testapiautodatamod_113470  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_113470`
...
2. Clone this repo and `cd testapiautodatamod_113470`
